    ...
    if (isSubmenu)
    {
        if (currentSubScreen == COLOR)
        {
            ...
            if(inputBufferLen==0){
                ...
                {
                case 0:
                    displayLongNumber(THREE_DIGIT_INDEX, atoi(inputBuffer), CRGB(255,0,0));
                    break;
                case 1:
                    displayLongNumber(THREE_DIGIT_INDEX, atoi(inputBuffer), CRGB(0,255,0));
                    break;
                case 2:
                    displayLongNumber(THREE_DIGIT_INDEX, atoi(inputBuffer), CRGB(0,0,255));
                    break;
                default:
                    break;
                }
        ...
        }else if (currentSubScreen == CURRENT_TIME)
        {
            ...
            } 
            {
                ...
                displayNumber(0, (v - v % 100) / 100, currentColor);
                displayNumber(70, v % 100, currentColor);
            }
        }
